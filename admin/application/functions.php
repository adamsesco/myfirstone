...
function get_youtube_embude($link){
    $ex = explode("watch?v=", $link);
                
                $vars = '<iframe style="border:0;" src="https://www.youtube.com/embed/' . $ex[1] . '" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="100%" height="140px"></iframe>';
    
    return $vars;
}


function getInfo($db, $where, $type){
	
        $sql = mysql_query("SELECT * FROM $db WHERE $where");
